...
public class PersonOverviewController {
	 ...
	 */
	/**
	 * @FXML private void initialize() { // Inicializa a tablea de pessoa com
	 *       duas colunas. firstNameColumn.setCellValueFactory(cellData ->
	 ...
	 */
	/**
	 * @FXML private void handleDeletePerson() { int selectedIndex =
